			...
			<div class="container-fluid">
				<form method="post" id="modal-form" action="add_customer.php" enctype="multipart/form-data" class="needs-validation">
		  			...
		  			<div align="center">
		  				...
		  				<input class="form-control form-control-sm" type="text" name="firstname" placeholder="Enter First name" required></div>
		  				...
		  				<input class="form-control form-control-sm" type="text" name="lastname" placeholder="Enter Last name" required></div>
